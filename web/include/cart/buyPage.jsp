...
<div class="buyPageDiv">
  <form action="forecreateOrder" method="post">
	...
	<div class="buyFlow">
		<img class="pull-left" src="img/site/ab.jpg" height="100px">
		...
		<div>
			...
			<table class="addressTable">
				<tr>
					...
					<td><textarea class="form-control" name="address" placeholder="建议您如实填写详细收货地址，例如接到名称，门牌好吗，楼层和房间号等信息"></textarea></td>
				</tr>
				<tr>
					<td>邮政编码</td>
			...
			<thead>
				<tr>
					<th colspan="2" class="productListTableFirstColumn">
						<img class="tmallbuy" src="img/site/jier.png">
						<a class="marketLink" href="#nowhere">店铺：542商城</a>
					</th>
					<th>单价</th>
					<th>数量</th>
					<th>小计</th>
